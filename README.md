...
On __macOS__, if you are using the [nix package manager](https://github.com/NixOS/nix), adapt the provided [shell.nix](shell.nix) to your setup, then type:\
`nix-shell`\
You can also setup [direnv](https://direnv.net/) so that the provided [.envrc](.envrc)\
can invoke `nix-shell` for you as soon as you navigate to the project directory
